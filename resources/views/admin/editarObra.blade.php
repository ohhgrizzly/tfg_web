       ...
       <div class="container h-100">
           <div class="row no-margin h-100">
               <div class="bg-layer d-flex col-md-4">
                    ...
                    <form method="POST" action="{{ route('actualizarObraAdmin.actualizar', $obra->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="{{ $obra->titulo }}" name="titulo" aria-label="Titulo" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
